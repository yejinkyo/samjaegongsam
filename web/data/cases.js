...
window.TARAE_CASES = [
  {
    ...
    "next_action": {
      ...
      "also": [
        ...
        },
        {
          ...
          "action": "ACT-진행확인",
          "label": "수사 진행상황 확인",
          "why": "수사가 진행 중이면 아직 불복할 결정이 없다. 진행상황을 확인하는 것이 먼저다"
        }
      ],
    ...
    "actions": [
      ...
      },
      {
        ...
        "label": "수사 진행상황 확인",
        "why": "수사가 진행 중이면 아직 불복할 결정이 없다. 진행상황을 확인하는 것이 먼저다",
        "rule_why": "수사가 진행 중이면 아직 불복할 결정이 없다. 진행상황을 확인하는 것이 먼저다",
        "due": null,
        "state": "no_submission",
        "rows": [],
        "prepare": null,
        "note": "경찰이 수사 중인 단계라 따로 낼 서류는 없습니다. 담당 수사관에게 수사 진행상황을 알려 달라고 요청할 수 있습니다(경찰수사규칙 제11조 제2항). 경찰은 수사를 시작한 날, 그로부터 3개월이 지난 날, 그 뒤 매 1개월이 지난 날부터 각각 7일 이내에 진행상황을 알려야 합니다(같은 조 제1항). 새 자료가 생기면 자료·의견 제출로 냅니다(수사준칙 제25조).",
        "unverified": true,
        "also": [
          {
            "rule_no": 8,
      ...
      "불송치": {
        ...
        "actions": [
          ...
          },
          {
            ...
            "action": "ACT-근거보완",
            "label": "주장을 뒷받침할 근거 자료 보완",
            "why": "ACT-회신 을(를) 2026-06-24 에 냈다고 기록했지만, 접수증이 자료함에 없습니다.",
            "rule_why": "근거 없는 주장은 판단 대상이 되지 않는다",
            "due": null,
            "state": "no_submission",
            "rows": [],
  ...
  },
  {
    ...
    "issues": [
      {
        ...
        "items": [
          {
            "text": "‘본인은 2019년 3월 초순 오후 ○○시장 입구에서 김민수로 보이는 남…’ — 기록 자료(통지서·접수증 등)에서는 확인되지 않는 진술입니다. ‘수사결과 통지서’(2022-03-15)보다 앞선 내용입니다. 수사 기록에 반영됐는지 확인이 필요합니다",
    ...
    "actions": [
      ...
      },
      {
        ...
        "action": "ACT-기록열람",
        "label": "수사 기록 열람 신청",
        "why": "‘본인은 2019년 3월 초순 오후 ○○시장 입구에서 김민수로 보이는 남…’ — 기록 자료(통지서·접수증 등)에서는 확인되지 않는 진술입니다. ‘수사결과 통지서’(2022-03-15)보다 앞선 내용입니다. 수사 기록에 반영됐는지 확인이 필요합니다",
        "rule_why": "수사 기록 없이는 다른 판단이 불가능하다",
        "due": null,
        "state": "filled",
        "rows": [
      ...
      "불송치": {
        ...
        "actions": [
          ...
          },
          {
            ...
            "action": "ACT-근거보완",
            "label": "주장을 뒷받침할 근거 자료 보완",
            "why": "ACT-회신 을(를) 2026-09-11 에 냈다고 기록했지만, 접수증이 자료함에 없습니다.",
            "rule_why": "근거 없는 주장은 판단 대상이 되지 않는다",
            "due": null,
            "state": "no_submission",
            "rows": [],
  ...
  },
  {
    ...
    "issues": [
      {
        ...
        "items": [
          {
            "text": "‘2025. 6. 3. ○○시 중앙시장 앞에서 박현수를 목격하였습니다.’ — 기록 자료(통지서·접수증 등)에서는 확인되지 않는 진술입니다. ‘수사결과 통지서’(2026-08-18)보다 앞선 내용입니다. 수사 기록에 반영됐는지 확인이 필요합니다",
    ...
    "actions": [
      ...
      },
      {
        ...
        "action": "ACT-기록열람",
        "label": "수사 기록 열람 신청",
        "why": "‘2025. 6. 3. ○○시 중앙시장 앞에서 박현수를 목격하였습니다.’ — 기록 자료(통지서·접수증 등)에서는 확인되지 않는 진술입니다. ‘수사결과 통지서’(2026-08-18)보다 앞선 내용입니다. 수사 기록에 반영됐는지 확인이 필요합니다",
        "rule_why": "수사 기록 없이는 다른 판단이 불가능하다",
        "due": null,
        "state": "filled",
        "rows": [
      ...
      "불송치": {
        ...
        "actions": [
          ...
          },
          {
            ...
            "action": "ACT-근거보완",
            "label": "주장을 뒷받침할 근거 자료 보완",
            "why": "ACT-회신 을(를) 2026-09-12 에 냈다고 기록했지만, 접수증이 자료함에 없습니다.",
            "rule_why": "근거 없는 주장은 판단 대상이 되지 않는다",
            "due": null,
            "state": "no_submission",
            "rows": [],
      ...
      "불송치": {
        ...
        "actions": [
          ...
          },
          {
            ...
            "action": "ACT-근거보완",
            "label": "주장을 뒷받침할 근거 자료 보완",
            "why": "ACT-회신 을(를) 2026-09-16 에 냈다고 기록했지만, 접수증이 자료함에 없습니다.",
            "rule_why": "근거 없는 주장은 판단 대상이 되지 않는다",
            "due": null,
            "state": "no_submission",
            "rows": [],
